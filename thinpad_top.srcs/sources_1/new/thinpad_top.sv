...
//  assign ext_ram_we_n = 1'b1;
  ...
  wb_mux WB_MUX_u(
    ...
    .mem_data(dm_data_out),
    .result(wb_wdata)
  );

  //tmp
  always_comb begin
    if(id_exe_rf_wen && (id_rs1 == id_exe_rd || id_rs2 == id_exe_rd)
    || exe_mem_rf_wen && (id_rs1 == exe_mem_rd || id_rs2 == exe_mem_rd)
    || wb_rf_we && (id_rs1 == wb_rd || id_rs2 == wb_rd))begin
      exe_stall_req = 1;
    end else begin
      exe_stall_req = 0;
    end
